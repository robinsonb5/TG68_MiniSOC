...
xst -ifn xst.scr
move Clock_50to100Split_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\Clock_50to100Split_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc Clock_50to100Split_exdes.ucf Clock_50to100Split_exdes

echo 'Running map'
map -timing -pr b Clock_50to100Split_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm Clock_50to100Split_exdes -w routed.ncd routed.vhd
cd ..
